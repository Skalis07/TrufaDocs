...
"""
    ...
    def test_parse_pdf_recognizes_experience_heading_without_professional(self) -> None:
        """El heading nuevo `EXPERIENCE` tambien debe reconocerse como core."""
        assembled = {
            "header": {
                "name": "Sample Candidate",
                "email": "",
